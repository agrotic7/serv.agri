  ...
  return (
    ...
    >
      ...
      <div className="dashboard-stats">
        ...
        <div className="dashboard-card">
          <span className="dashboard-card-title">Newsletter</span>
          <span className="dashboard-card-value">{loading ? '...' : newsletterCount}</span>
        </div>
        <div className="dashboard-card">
          <span className="dashboard-card-title">Messages</span>
          <span className="dashboard-card-value">{loading ? '...' : messagesCount}</span>
        </div>
      </div>
      <div className="dashboard-actions">
        ...
        <a href="/admin/contacts" className="dashboard-action-btn" style={{background:'#3b82f6'}}>📨 Voir les messages</a>
      </div>
