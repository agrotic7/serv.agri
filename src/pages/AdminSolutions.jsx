...
// Composant de Lazy Loading pour les miniatures d'administration
function LazyAdminVideo({ s }) {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: "200px" });

  return (
    <div className="service-img-refonte" ref={ref}>
      {s.video ? (
        isInView ? (
          <video className="service-video-refonte" preload="none" autoPlay loop muted playsInline poster={s.img}>
